...
description: 폼 상태를 생성하고 구독할 수 있도록 준비합니다.
sidebar: apiLinks
---
...
| `subscribe`   | <TypeText>Function</TypeText>  | 렌더링을 발생시키지 않고 폼 상태 변화를 [감지](/docs/useform/subscribe)하는 함수 |
| `...returns`  | <TypeText>Functions</TypeText> | `useForm`이 반환하는 메서드들                                                    |

<Admonition type="important" title="Notes">
  - 이 함수는 **v7.55.0** 버전부터 제공됩니다. - 이 함수는 완전히 선택적
