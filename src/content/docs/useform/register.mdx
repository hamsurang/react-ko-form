...
TypeScript의 일관성을 위해 점 표기법만 지원됩니다—대괄호 표기법(<code>[]</code>)은 배열 폼 값에서 작동하지 않습니다.  
...
<li>매 렌더링마다 인풋의 <code>name</code>을 변경하면 새로운 필드로 다시 등록됩니다.  
        일관된 동작을 보장하기 위해 각 렌더링에서 인풋 이름을 안정적으로 유지하세요.</li>  
  <li>
