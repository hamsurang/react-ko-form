...
이름은 숫자로 시작해서는 안되며 숫자를 단독 키로 사용해서는 안 되며, 특수 문자는 피해야 합니다.  
...
사용자가 수정하는 것을 방지하면서 값을 유지해야 하는 경우, <code>readOnly</code>를 사용하거나 전체 <code>fieldset</code>을 비활성화하세요. 여기 [예제](https://codesandbox.io/s/react-hook-form-disabled-inputs-oihxx)가 있습니다.</li>  
