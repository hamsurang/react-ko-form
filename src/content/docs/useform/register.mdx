...
<ul>
  <li>
<strong>Name</strong>은 <strong>필수</strong>이며 <strong>고유해야 합니다</strong>
...
register("test[0].firstName") // ❌
  ...
  <li> 비활성화된 인풋은 <code>undefined</code>를 폼 값으로 반환합니다.
        사용자가 값을 수정하지 못하도록 하면서 값을 유지해야 하는 경우,
        <code>readOnly</code>를 사용하거나 전체 <code>fieldset</code>을 비활성화하세요. [여기](https://codesandbox.io/s/react-hook-form-disabled-inputs-oihxx) 예시가 있습니다.</li>
