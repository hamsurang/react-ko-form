...
| 이름                | <TypeText>타입</TypeText>                                            | 필수     | 설명                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|-------------------|------------------------------------------------------------------------------------|----------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `exact`           | <TypeText>boolean = false</TypeText>                             |          | 이 속성은 인풋 이름 구독에 대한 정확한 매칭을 활성화하며, 기본값은 true입니다.                                                                                                                                                                                                                                                                                                                                               | 
### Props
...
| `formState`                            | `exact`              | <TypeText>boolean = false</TypeText>        | 이 속성(prop)은 입력 필드 이름 구독의 정확한 매칭을 활성화하며, 기본값은 `true`입니다.                                                                                                                                                                                                                                                                                                                                                                                                            |
...
- MUI, AntD, Chakra UI와 같은 외부 제어 컴포넌트를 사용할 때 각 prop의 역할을 이해하는 것이 중요합니다. Controller는 값을 알리고 설정함으로써 입력 필드의 "스파이" 역할을 합니다.
  ...
  - **exact**: 이 속성(prop)을 true로 설정하면 인풋 필드 이름 구독에 대해 정확히 일치하는지를 확인합니다. 기본값은 true입니다.
