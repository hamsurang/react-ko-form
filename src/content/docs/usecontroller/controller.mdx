...
| `exact`            | <TypeText>boolean = false</TypeText>                               |          | 이 속성(prop)은 인풋 이름 구독에 대한 정확한 매칭을 활성화합니다. 기본값은 true입니다.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | 
### Props
...
| `exact`            | <TypeText>boolean = false</TypeText>                               |          | 이 속성은 인풋 이름 구독에 대해 정확한 일치를 활성화합니다. 기본값은 `false`입니다.                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
### Return
...
| `formState`                            | `exact`              | <TypeText>boolean = false</TypeText>        | 입력 이름 구독에 대해 정확히 일치하는 매칭을 활성화합니다. 기본값은 `true`입니다.                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
- MUI, AntD, Chakra UI와 같은 외부 제어 컴포넌트를 사용할 때 각 prop의 역할을 이해하는 것이 중요합니다. Controller는 값을 알리고 설정함으로써 입력 필드의 "스파이" 역할을 합니다.
  ...
  - **exact**: 입력 이름 구독에 대한 정확한 매칭을 활성화하며, 기본값은 true입니다.
    다음 코드샌드박스는 사용 예시를 보여줍니다:
