...
| [progressive](/docs/useform/form)                       | `Form` 컴포넌트를 사용할 때 네이티브 폼 제출을 위한 점진적 강화 기능을 활성화합니다.                                    |
...
`validate` 함수는 전체 폼 객체를 받아오며, `formState.errors`와 통합된 **구조적 에러**를 반환할 수 있습니다.
